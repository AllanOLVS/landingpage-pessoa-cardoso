        ...
        <section id="atuacao" className="py-24 bg-stone-50 border-t border-stone-200">
            <div className="container mx-auto px-6 lg:px-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {/* Direito Eleitoral */}
                    <ScrollReveal direction="left">
                        <div className="bg-white p-10 rounded-sm shadow-sm border border-stone-100 hover:shadow-xl hover:-translate-y-1 transition-all group h-full">
                    ...
                    {/* Extra Info Card */}
                    <ScrollReveal direction="right">
                        <div className="bg-stone-900 p-10 rounded-sm shadow-sm border border-stone-800 flex flex-col justify-center items-center text-center h-full">
